...
if __name__ == '__main__':
    print("[get_weibo_cookie.py] BASE_DIR: ", BASE_DIR)
    account_file = Path(BASE_DIR / "cookies" / "weibo_uploader" / "account.json")
    print("[get_weibo_cookie.py] account_file: ", account_file)
    cookie_setup = asyncio.run(weibo_setup(str(account_file), handle=True))
